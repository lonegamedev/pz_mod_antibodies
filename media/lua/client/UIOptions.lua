    ...
    addNumberGroup("MoodleEffects", -1.0, 1.0, 
        {
            ...
            ["Hypothermia"] = getText("UI_Antibodies_MoodleHypothermia"),
            ["Hyperthermia"] = getText("UI_Antibodies_MoodleHyperthermia"),
    ...
    addNumberGroup("TraitsEffects", -1.0, 1.0, 
        {
            ...
            ["OutOfShape"] = getText("UI_trait_outofshape"),
            ...
            ["VeryUnderweight"] = getText("UI_trait_veryunderweight"),
