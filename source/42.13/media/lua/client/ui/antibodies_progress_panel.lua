...
function AntibodiesProgressPanel:getRadialTexture()
	if not self.radialTexture then
		self.radialTexture = getTexture("media/ui/lgd_antibodies_radial_progress.png")
	end
	return self.radialTexture
end
